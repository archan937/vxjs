...
_.class=_.C=function(n,d,y,k,h){y=(d?d:document).getElementsByTagName("*");h=[];for(k=y.length;k--;)_.I(n,y[k].className.split(" "))<0?0:h.push(y[k]);return h}
...
_.include=_.N=function(s,e){e=document.createElement('script');e.src=s;document.body.appendChild(e)}

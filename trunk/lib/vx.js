...
function vA(h,p,s,e,r,x,f,i,b){var k=(e-s)/f,u=0,c=setInterval(function(){if(u++<f){h.style[p]=r+(s+k*u)+x}else{clearInterval(c);b?b():b}},i);return c}
function vE(e,t,f,r){if(e.attachEvent){r?e.detachEvent('on'+t,e[t+f]):r;if(!r){e['e'+t+f]=f;e[t+f]=function(){e['e'+t+f](window.event)};e.attachEvent('on'+t,e[t+f]);}}else

...
_.Ac=function(v,n,c,u,y){u=0
return y=setInterval(function(){c(u/v);u++>=v?clearInterval(y):0},n)}
...
_.N=function(n){var r=_.N,p=n.split('.');for(var i=0;i<p.length&&p[i];i++){if(r[p[i]]==undefined)r[p[i]]={};r=r[p[i]]}return r}

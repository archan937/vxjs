...
_.L=function(n,d,y,k,h){y=(d?d:document).getElementsByTagName("*");h=[];k=y.length;while(k--)_.I(n,y[k].className.split(" "))<0?0:h.push(y[k]);return h}
...
_.I=function(v,a,i){i=a.length;while(i--&&a[i]!=v);return i}
